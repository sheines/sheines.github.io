...
\begin{tikzpicture}[pfeil, xscale=1, yscale=0.7]
	...
	\node[draw,rectangle, thick,darkgoldenrod] (F1) at (4,4) {$E$};
	\node[draw,rectangle, thick,darkgoldenrod] (F2) at (4,-4) {$\overline E$};
	
	\draw[very thick, darkgoldenrod] (S) -- node[above, sloped] {$\scriptstyle  p$} (F1);
	\draw[very thick, darkgoldenrod] (S) -- node[below, sloped] {$\scriptstyle  p-1$} (F2);

	% Stufe 2
	\node[draw,rectangle, thick] (F11) at (8,6) {$E$};
	\node[draw,rectangle, thick,darkgoldenrod] (F12) at (8,2) {$\overline E$};
	
	\draw[very thick] (F1) -- node[above, sloped] {$\scriptstyle p$} (F11);
	\draw[very thick,darkgoldenrod] (F1) -- node[below, sloped] {$\scriptstyle p-1$} (F12);

	\node[draw,rectangle, thick,darkgoldenrod] (F21) at (8,-2) {$E$};
	\node[draw,rectangle, thick,darkgoldenrod] (F22) at (8,-6) {$\overline E$};
	
	\draw[very thick, darkgoldenrod] (F2) -- node[above, sloped] {$\scriptstyle p$} (F21);
	\draw[very thick, darkgoldenrod] (F2) -- node[below, sloped] {$\scriptstyle p-1$} (F22);
	...
	\node[draw,rectangle, thick,darkgoldenrod] (F122) at (12,1) {$\overline E$};
	
	\draw[very thick] (F12) -- node[above, sloped] {$\scriptstyle p$} (F121);
	\draw[very thick,darkgoldenrod] (F12) -- node[below, sloped] {$\scriptstyle p-1$} (F122);	

	\node[draw,rectangle, thick] (F211) at (12,-1) {$E$};
	\node[draw,rectangle, thick,darkgoldenrod] (F212) at (12,-3) {$\overline E$};
	
	\draw[very thick] (F21) -- node[above, sloped] {$\scriptstyle p$} (F211);
	\draw[very thick,darkgoldenrod] (F21) -- node[below, sloped] {$\scriptstyle p-1$} (F212);

	\node[draw,rectangle, thick,darkgoldenrod] (F221) at (12,-5) {$E$};
	\node[draw,rectangle, thick,darkgoldenrod] (F222) at (12,-7) {$\overline E$};
	
	\draw[very thick,darkgoldenrod] (F22) -- node[above, sloped] {$\scriptstyle p$} (F221);
	\draw[very thick,darkgoldenrod] (F22) -- node[below, sloped] {$\scriptstyle p-1$} (F222);
	...
	\node[draw,rectangle, thick,darkgoldenrod] (F1222) at (16,0.5) {$\overline E$};
	
	\draw[very thick] (F122) -- node[above, sloped] {$\scriptstyle p$} (F1221);
	\draw[very thick,darkgoldenrod] (F122) -- node[below, sloped] {$\scriptstyle p-1$} (F1222);
	...
	\node[draw,rectangle, thick,darkgoldenrod] (F2122) at (16,-3.5) {$\overline E$};
	
	\draw[very thick] (F212) -- node[above, sloped] {$\scriptstyle p$} (F2121);
	\draw[very thick,darkgoldenrod] (F212) -- node[below, sloped] {$\scriptstyle p-1$} (F2122);
	
	\node[draw,rectangle, thick] (F2211) at (16,-4.5) {$E$};
	\node[draw,rectangle, thick,darkgoldenrod] (F2212) at (16,-5.5) {$\overline E$};
	
	\draw[very thick] (F221) -- node[above, sloped] {$\scriptstyle p$} (F2211);
	\draw[very thick,darkgoldenrod] (F221) -- node[below, sloped] {$\scriptstyle p-1$} (F2212);	
	
	\node[draw,rectangle, thick,darkgoldenrod] (F2221) at (16,-6.5) {$E$};
	\node[draw,rectangle, thick] (F2222) at (16,-7.5) {$\overline E$};
	
	\draw[very thick,darkgoldenrod] (F222) -- node[above, sloped] {$\scriptstyle p$} (F2221);
