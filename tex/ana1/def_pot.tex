...
\begin{tikzpicture}[pfeil]
	...
	\draw[very thick,domain=-4.5:3.65, smooth, samples=50, darkgoldenrod] plot(\x,{0.1*(\x-3)*(\x+1)*(\x+4)});

    \draw[line width=7.5px, green, opacity=0.35,-] (-4.5,0) -- (4.5,0);
    ...
    % }
    % }
    \node[right] at (-4.5,2) {$\scriptstyle f(x)=\frac{1}{10}\left(x^3 + 2 x^2 - 11 x - 12\right)$};
