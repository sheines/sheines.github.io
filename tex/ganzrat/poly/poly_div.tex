...
\newcommand{\link}[2]{\tikz[baseline, remember picture]{\node[anchor=base] (#1) {$#2$}}}
...
\begin{align*}
	4x-6&=4
	% \begin{array}[t]{*{25}{r}}
	% 	\big( x^3&-\pb x^2\pb &-\pb14x\pb&+\pb24\big)&:&\big( x+4\big) = x^2-5x+6
	% 	% \big( \link{a1}{x^3}&-\pb x^2\pb &\link{a5}{-\pb14x}\pb&\link{a9}{+\pb24}\big)&:&\big( x+4\big) =  \link{e1}{x^2}\link{e2}{-5 x}\link{e3}{+6}\\
