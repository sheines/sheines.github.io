...
\usetikzlibrary{patterns, animations, math}
...
\begin{tikzpicture}[overlay]
	\draw[-stealth, cyan, thick] (a1) to [in=160, out=20] node[above,sloped] {$x^3:x=$} (e1); % 
	\draw[-stealth, green, thick] (e1) to [in=0, out=210] node[below,sloped] {$x^2\cdot (x+4)=$} (a2);
	\draw[-stealth, orange, thick] (a2) to [out=-20, in=20] node[right] {$(x^3-x^2) - (x^3+4x^2)=$} (a4);
	\draw[-stealth, magenta, thick] (a5) to (a6);
	\draw[-stealth, cyan, thick] (a17) to [in=250, out=-30] node[below,sloped] {$-5x^2:x=$} (e2);
	\draw[-stealth, green, thick] (e2) to [in=0, out=210] node[below,sloped] {$-5x\cdot (x+4)=$} (a7);
	\draw[-stealth, orange, thick] (a7) to [out=-20, in=20] node[right] {$(-5x^2-14x) - (-5x^2-20x)=$} (a8);
	\draw[-stealth, magenta, thick] (a9) to (a10);
	\draw[-stealth, cyan, thick] (a11) to [in=250, out=-30] node[below,sloped] {$6x:x=$} (e3);
	\draw[-stealth, green, thick] (e3) to [in=0, out=270] node[below,sloped] {$6\cdot (x+4)=$} (a12);
	\draw[-stealth, orange, thick] (a12) to [out=-20, in=20] node[right] {$(6x+24) - (6x+24)=$} (a13);
\end{tikzpicture}

% Division (blau), Multiplikation (grün) Subtraktion (orange), Nachholen (magenta)

% \begin{tikzpicture}
% 	\node[cyan!30] at (-3,0) {\only<2,3,10,11,18,19>{\color{blue}\bfseries}Division};
