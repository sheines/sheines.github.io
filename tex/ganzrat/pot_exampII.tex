...
\begin{tikzpicture}[pfeil, yscale=0.95,xscale=1.4,>=stealth]
	...
	\draw[thin, step=0.5] (-2.49,-2.49) grid (2.49,2.49);
		...
		\draw[ultra thick, petrol-lighter, domain=-2:2, samples=50, smooth] plot(\x,{-1/2*\x*\x}) node[below left] {$f(x)$};
		\draw[ultra thick, darkgoldenrod, domain=-2:2, samples=50, smooth] plot(\x,{-1/4*\x*\x*\x}) node[above right] {$g(x)$};
