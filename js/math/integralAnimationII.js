...
const riemannUSvg = document.getElementById("riemannUSvg");
const riemannOSvg = document.getElementById("riemannOSvg");
...
animateRiemannSum(p, riemannUSvg, "Darkgoldenrod", "Yellow", 0, 4, rectCountArray, "left", true, 0.20);
plotFunction(p, riemannUSvg, "Aqua", 0, 4.25);

animateRiemannSum(p, riemannOSvg, "Blue", "Lightblue", 0, 4, rectCountArray, "right", true, 0.20);
plotFunction(p, riemannOSvg, "Aqua", 0, 4.25);
