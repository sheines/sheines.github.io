document.addEventListener("DOMContentLoaded", function () {
  ...
  setTimeout(() => {
    ...
    graph.animate([{ strokeDashoffset: pathLength }, { strokeDashoffset: 0 }], {
      duration: 2000,
      fill: "forwards",
    });
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          areaOutline.setAttribute("width", areaRect.width);
          areaOutline.setAttribute("height", areaRect.height);

          // Animate the rectangle's position using the 'translateX' animation with a duration of 3 seconds
          areaOutline.style.animation = "translateX 3s forwards";
          ...
          // Set the rectangle's stroke to red for visibility
          areaOutline.setAttribute("stroke", "none");
          //areaOutline.setAttribute("stroke-width", "2");
